...
#let passo_a_passo = block[
  ...
  #enum.item(
    2,
  )[Avança pela fita passando por todos _y_ e $x_x$ -- que são os $x$'s já pareados -- até encontrar um $x$ ou o fim da fita.]
  #align(center)[
    #set text(size: 9pt)
    #diagram(
      node-stroke: .1em,
  ...
  #align(center)[
    ...
    #diagram(
      node-stroke: .1em,
      {
        ...
        edge(f, d, "-|>", label-side: left, dash: "dotted")[$epsilon,epsilon bar "I"$]
      },
    )
  ]
  #block[
